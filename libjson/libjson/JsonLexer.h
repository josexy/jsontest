    ...
    void analysis() {
        ...
        switch (c) {
            ...
            case '\"': {
                ...
                return token_list.push_back(std::make_shared<String>(
                    s, lineNumber, start_col, s.length()));
            }
            ...
            case ',':
                return token_list.push_back(std::make_shared<Token>(
                    Tag::JSON_SEP, lineNumber, colNumber, 1));
            case '{':
                return token_list.push_back(std::make_shared<Token>(
        ...
        if (isnumber(c) || c == '-' || c == '+') {
            ...
            if (c == '.' || isexponent(c)) goto __fraction_exponent;
