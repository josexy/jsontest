...
struct indexOfValue {};
template <>
struct indexOfValue<std::string> {
    static constexpr int index = 0;
};
template <>
struct indexOfValue<int> {
    static constexpr int index = 1;
};
template <>
struct indexOfValue<double> {
    static constexpr int index = 2;
};
template <>
struct indexOfValue<bool> {
...
class Identifier : public Token {
   public:
    Identifier(Tag tag, const std::string& identifier, int line, int col,
               int len)
